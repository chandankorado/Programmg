...
// Actual code [logic] function definition for calc Completion time
...
int main()
{
   ...
   sort(at,bt,n);       // Sorting with respect to Arrival time
    Hat = 0;
    for(i=0;i<=n;i++)   // calc Highest Arrival time
    {
        if(Hat < at[i])
            Hat = at[i];
    }
...
// Actual code [logic] function call for calc Completion time
